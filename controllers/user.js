...
exports.getAccount = (req, res) => {
  res.render('account/profile', {
    title: 'Account Management', user: req.user, userEmail: req.user.email
  });
};
...
exports.postUpdateProfile = (req, res, next) => {
  ...
  User.findById(req.user.id, (err, user) => {
    ...
    user.preferences.ageRangeHigh = req.body.maxAge || 65;
    user.preferences.religion = req.body.religion || "Unspecified";
    user.save((err) => {
      if (err) {
        if (err.code === 11000) {
  ...
  async.waterfall([
    ...
    function (user, done) {
      ...
      const mailOptions = {
        ...
        subject: 'Your Little League password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  async.waterfall([
    ...
    function (token, user, done) {
      ...
      const mailOptions = {
        to: user.email,
        from: 'nick@nickwhite.is',
        subject: 'Reset your password on Little League',
